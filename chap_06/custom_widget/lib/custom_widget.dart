...
class VerificationCodeInput extends StatefulWidget {
  ...
  _VerificationCodeInputState createState() {
    return _VerificationCodeInputState();
  }
}
...
class _VerificationCodeInputState extends State<VerificationCodeInput> {
  ...
  Widget build(BuildContext context) {
    return TextField(
      ...
      decoration: InputDecoration(border: OutlineInputBorder(borderSide: widget.borderSide),
      ),
...
class VerificationCodeFormField extends FormField<String> {
  ...
  VerificationCodeFormField({
    ...
    builder: (FormFieldState<String> field) {
      ...
      return VerificationCodeInput(controller: state._controller,
      );
    },
  );
